...
def run(args: argparse.Namespace):
    ...
    while True:
        ...
        # Initialize generated_text outside the loop to avoid reference error
        generated_text = ""
        ...
        # Print the full generated text in one line after the loop finishes
        print(generated_text, end='')  # This avoids line breaks and prints the text in one continuous line
